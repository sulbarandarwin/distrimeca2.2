            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('Admin')
                        ...
                        <x-nav-link :href="route('admin.import_export.index')" :active="request()->routeIs('admin.import_export.*')">
                            {{ __('Importar/Exportar') }}
                        </x-nav-link>
                        {{-- ENLACE CONFIGURACIÓN (BARRA PRINCIPAL) --}}
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('Admin')
                <x-responsive-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')"> {{ __('Admin Dashboard') }} </x-responsive-nav-link>
                 ...
                 <x-responsive-nav-link :href="route('admin.suppliers.index')" :active="request()->routeIs('admin.suppliers.*')"> {{ __('Proveedores') }} </x-responsive-nav-link>
                 ...
                 <x-responsive-nav-link :href="route('admin.audit-log.index')" :active="request()->routeIs('admin.audit-log.*')"> {{ __('Auditoría') }} </x-responsive-nav-link>
                 <x-responsive-nav-link :href="route('admin.import_export.index')" :active="request()->routeIs('admin.import_export.*')"> {{ __('Importar/Exportar') }} </x-responsive-nav-link>
                 {{-- ENLACE CONFIGURACIÓN (RESPONSIVE) --}}
                 <x-responsive-nav-link :href="route('admin.settings.index')" :active="request()->routeIs('admin.settings.*')"> {{ __('Configuración') }} </x-responsive-nav-link>
            @endrole
        </div>
