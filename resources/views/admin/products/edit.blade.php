<x-app-layout>
    @section('title', __('Editar Producto') . ' - ' . $product->name)
                        ...
                        {{-- Descripción --}}
                         <div>
                            ...
                            <textarea id="description" name="description" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300">{{ old('description', $product->description) }}</textarea>
