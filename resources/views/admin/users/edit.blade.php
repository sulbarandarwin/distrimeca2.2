                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400">Dejar en blanco para no cambiar la contraseña actual.</span>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-2 space-y-2">
                                @php
                                    // Obtenemos los IDs de los roles que el usuario YA tiene asignados
                                    // Usamos old() para mantener la selección si falla la validación
                                ...
                                @forelse ($roles as $role)
                                    <label for="role_{{ $role->id }}" class="flex items-center">
                                        <input id="role_{{ $role->id }}" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800"
                                               ...
                                               {{-- Marcamos el checkbox si el ID está en los datos antiguos O en los roles actuales del usuario --}}
